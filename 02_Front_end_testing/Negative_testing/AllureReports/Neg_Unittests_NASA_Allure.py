...
class ChromeBrowser(unittest.TestCase):
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC-47: "Verify the error message when "First Name" left empty."  ......
    # .......................(Methods in UnitTest should start from "test" keyword).....
    def test47_first_name_empty(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC_48: "Verify  the error message when "Last Name" left empty."  ......
    # .......................(Methods in UnitTest should start from "test" keyword).....
    def test48_last_name_empty(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC-49: "Verify  the error message when "Email" left empty."  ......
    def test49_email_empty(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC-50: "Verify  the error message when "Email" is invalid"  ......
    # .......................(Methods in UnitTest should start from "test" keyword).....
    def test50_email_invalid(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
...
class FirefoxNASATests(unittest.TestCase):
    ...
    # ......TC-51: Verify the webpage is accessible.........................
    # ......(Methods in UnitTest should start from "test" keyword).......
    def test51_webpage_access(self):
        driver1 = self.driver
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC-52: "Verify the error message when "First Name" left empty."  ......
    # .......................(Methods in UnitTest should start from "test" keyword).....
    def test52_first_name_empty(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC_53: "Verify  the error message when "Last Name" left empty."  ......
    # .......................(Methods in UnitTest should start from "test" keyword).....
    def test53_last_name_empty(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC-54: "Verify  the error message when "Email" left empty."  ......
    def test54_email_empty(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
    ...
    # >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    # ...............  TC-55: "Verify  the error message when "Email" is invalid"  ......
    # .......................(Methods in UnitTest should start from "test" keyword).....
    def test55_email_invalid(self):
        driver8 = self.driver
        url = "https://api.nasa.gov/"
        driver8.get(url)
        driver8.maximize_window()
...
#     unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='./HtmlReports_NEG_NASA',
#                                                            report_name='NEG_NASA_All_Tests'))
...
# # #
# # # >>    python -m pytest -v -s --alluredir="reports" Neg_Unittests_NASA_Allure.py
# # #

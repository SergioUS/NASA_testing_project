...
class ChromeBrowser(unittest.TestCase):
    ...
    def test4_asterisk_search(self):
        ...
        try:
            driver2.find_element(By.CSS_SELECTOR, ".api-umbrella-signup-embed-content-container")
        ...
        try:
            host_element = driver2.find_element(By.CSS_SELECTOR, ".api-umbrella-signup-embed-content-container")
            shadow_root = driver2.execute_script('return arguments[0].shadowRoot', host_element)

            # .....(Use JavaScript to access the shadow root and find elements within it)......
            inner_element = driver2.execute_script('return arguments[0].shadowRoot.querySelector("div:nth-child(1) > '
